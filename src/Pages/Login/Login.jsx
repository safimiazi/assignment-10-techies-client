                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-gray-700">
                    <form onSubmit={handleLogin} className="card-body ">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn hover:bg-gray-900 text-white bg-gray-900">Login</button>
                        </div>
                        <div>
                            <p className="text-white">are you new? please <NavLink to='/register' className="underline">register</NavLink></p>
                        </div>
                    </form>
